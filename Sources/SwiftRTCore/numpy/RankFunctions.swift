...
/// - Parameters:
///  - arrays: the arrays to concatenate. The arrays must have the same shape,
...
///  - out: If provided, the destination to place the result. The shape
///    must be correct, matching that of what concatenate would have
