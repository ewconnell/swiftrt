...
public final class MatmulAlgorithm: CustomStringConvertible {
  ...
  @inlinable public var reductionScheme: MatmulReductionScheme {
    get {
      var value: UInt32 = 0
      assert(MemoryLayout<cublasLtReductionScheme_t>.size == MemoryLayout.size(ofValue: value))
...
public struct MatmulNumericalOptions: OptionSet, CustomStringConvertible {
  ...
  public static let tensorOpMask = MatmulNumericalOptions(
  ...
  public static let accumulator16F = MatmulNumericalOptions(
    CUBLASLT_NUMERICAL_IMPL_FLAGS_ACCUMULATOR_16F)
  public static let accumulator32F = MatmulNumericalOptions(
    CUBLASLT_NUMERICAL_IMPL_FLAGS_ACCUMULATOR_32F)
  public static let accumulator64F = MatmulNumericalOptions(
    CUBLASLT_NUMERICAL_IMPL_FLAGS_ACCUMULATOR_64F)
  public static let accumulator32I = MatmulNumericalOptions(
    CUBLASLT_NUMERICAL_IMPL_FLAGS_ACCUMULATOR_32I)

  public static let accumulatorTypeMask = MatmulNumericalOptions(
  ...
  public static let inputTypeMask = MatmulNumericalOptions(
    CUBLASLT_NUMERICAL_IMPL_FLAGS_OP_INPUT_TYPE_MASK)

  public var description: String {
    var string = "["

    if rawValue == 0xFFFF_FFFF_FFFF_FFFF {
      string += ".all"
    } else {
...
public struct MatmulReductionSchemeOptions: OptionSet, CustomStringConvertible {
  ...
  public static let accumulatorType = MatmulReductionSchemeOptions(
