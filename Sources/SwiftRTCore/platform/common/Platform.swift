...
extension ComputePlatform {
  ...
  @inlinable public var isMainThread: Bool { pthread_self() == Self.mainThread }

  /// the currently active queue for expression evaluation
  @inlinable public var currentQueue: Device.Queue {
    isMainThread ? queueStack.last! : Self.syncQueue
  }

  /// the currently active device
  @inlinable public var currentDevice: Device {
  ...
  @inlinable public func validQueue(
    _ deviceId: Int,
    _ queueId: Int
  ) -> Device.Queue {
