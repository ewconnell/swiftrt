...
extension CpuFunctions where Self: DeviceQueue {
  ...
  @inlinable func cpu_fill<S, E>(
    ...
    diagnostic(
      .queueCpu, "fill(\(out.name), with: \(element)) on \(name)",
      categories: .queueCpu)
    mapOp(&out) { element }
  }
  ...
  @inlinable func cpu_fill<S, E>(
    ...
    diagnostic(
      .queueCpu, "fill(\(out.name), from: \(first), to: \(last)," + " by: \(step)) on \(name)",
      categories: .queueCpu)
  ...
  @inlinable func cpu_fill<S, E>(
    ...
    diagnostic(
      .queueCpu,
      "fill(randomUniform: \(out.name), lower: "
  ...
  @inlinable func cpu_fill<S, E>(
    ...
    diagnostic(
      .queueCpu,
      "fill(randomNormal: \(out.name), mean: " + "\(mean), std: \(std), seed: \(seed)) on \(name)",
      categories: .queueCpu)
  ...
  @inlinable func cpu_fill<S, E>(
    ...
    diagnostic(
      .queueCpu,
      "fill(randomNormal: \(out.name), mean: "
  ...
  @inlinable func cpu_fill<S, E>(
    ...
    diagnostic(
      .queueCpu,
      "fill(randomTruncatedNormal: \(out.name), mean: "
