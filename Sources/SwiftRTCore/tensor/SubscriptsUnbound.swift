...
extension Tensor {
  ...
  @inlinable public subscript(range: UnboundedRange) -> Self { self }

  //    @differentiable(where Self: DifferentiableTensor)
  @inlinable public subscript<R>(range: R) -> Self where R: SignedRangeExpression {
    get {
  ...
  @inlinable public func getItemRange(_ range: Range<Int>) -> (Shape, Shape) {
