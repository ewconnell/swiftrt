...
extension Int {
  @inlinable public prefix static func ..<- (upper: Int) -> PartialRangeUpTo<Int> {
    ..<(-upper)
  }

  @inlinable public prefix static func ...- (upper: Int) -> PartialRangeThrough<Int> {
    ...(-upper)
  }
}
...
extension Int {
  ...
  @inlinable public static func ..+ (lower: Int, extent: Int) -> Range<Int> {
    lower..<(lower + extent)
  }
}
