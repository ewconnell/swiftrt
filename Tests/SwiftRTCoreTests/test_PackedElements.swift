    ...
    func test_Bool1() {
        ...
        do {
            ...
            let a = array([ true, true, true, true, false,
                            true, false, false,  true, true], type: Bool1.self)
            let b = array([false, true, true, true, false,
                           true, false, false, false, true], type: Bool1.self)
            let c = a .&& b
            XCTAssert(c.storage.hostBuffer.count == 2)
            XCTAssert(c == [false, true, true, true, false,
                            true, false, false, false, true])
        }
        
        // modify element
        do {
            var a = array([false, true, false, true,
                           false, true, false, true], type: Bool1.self)
            a[2] = true
        ...
        do {
            ...
            XCTAssert(a.storage.hostBuffer.count == 2)
            XCTAssert(a == [
                [false, false, false, true, false],
                [false, false,  true, true, false]
            ])
